...
describe('reviews.addReview', () => {
  ...
  it('✅ allows writing a review when booking is completed', async () => {
    ...
    (Review.findOne as jest.Mock).mockResolvedValue(null); // no existing review
    ...
    expect(Review.create).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        title: 'Great',
        text: 'Nice stay',
        booking: expect.any(Object), // ObjectId created inside controller
      }),
    );
